...
@section('title', 'Kayıtlı Markaları Listele')

@section('content_header')
    <h1>Sistemde Kayıtlı Markalar</h1>
@stop
@section('style')
    <style>
        @media print {
        ...
        <div class="col-md-12">
            ...
            <div class="box box-danger box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-info-circle"></i> Sistemde Kayıtlı Markalar</h3>
                </div>
                <!-- /.box-header -->
                    ...
                    <table class="table table-bordered table-hover" id="myTable">
                        ...
                        @foreach ($brands as $key => $brand)
                            <tr id="post{{$key}}" class="">
                                ...
                                <td style="width:15%">
                                    <a href="{{ route('brands.edit', $brand->id) }}" class="btn btn-primary bold uppercase"><i class="fa fa-edit"></i> Düzenle</a>
