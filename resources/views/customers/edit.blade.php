...
@section('content')
    <div class="box box-danger box-solid">
        ...
        <div class="box-body pad">
            ...
            {!! Form::open(['route' => ['customers.update',$customer->id],'method' => 'PUT', 'files' => true ]) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="gsm" id="gsm" value="{{ $customer->gsm }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="identity_number" id="identity_number" value="{{ $customer->identity_number }}">
                    </div>
                </div>
            ...
            <div id="kurumsal" class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tax_authority" id="tax_authority" value="{{ $customer->tax_authority }}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tax_number" id="tax_number" value="{{ $customer->tax_number }}">
                    </div>
                </div>
